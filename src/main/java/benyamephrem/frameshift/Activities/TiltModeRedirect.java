...
public class TiltModeRedirect extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tilt_mode_redirect);
